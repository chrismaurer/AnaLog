...
def logExceptions(gwFlavour):
    logExceptions = [
        ...
        # isnore "Local Publisher::ResolveSubscribers push failed. Dropping data!"
    ...
    elif 'BTEC' in gwFlavour:
        logExceptions.extend(BTECExceptions())
    elif 'ICE' in gwFlavour:
        logExceptions.extend(ICEExceptions())
    elif 'CME' in gwFlavour or 'CBOT' in gwFlavour:
        logExceptions.extend(FIXExceptions())
    elif 'LME' in gwFlavour:
        logExceptions.extend(LMEExceptions())
    elif 'MEFF' in gwFlavour:
        logExceptions.extend(MEFFExceptions())
    elif 'NYSE_Liffe' in gwFlavour:
        logExceptions.extend(NYSE_LiffeExceptions())
